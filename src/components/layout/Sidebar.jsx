      ...
      <aside className={cn(
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-slate-800 bg-slate-900">
          <div className="flex items-center space-x-3 flex-1">
            {/* PartPulse Logo - with cache busting */}
            <img 
              src="https://partpulse.eu/images/PartPulse-logo.png?v=1.0" 
              alt="PartPulse Logo" 
              className="w-8 h-8 object-contain drop-shadow-lg flex-shrink-0"
              onError={(e) => {
                console.log('Logo failed to load, trying fallback...');
                e.target.src = 'data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22%3E%3Crect fill=%2214b8a6%22 width=%22100%22 height=%22100%22/%3E%3Ctext x=%2250%22 y=%2250%22 font-size=%2250%22 fill=%22white%22 text-anchor=%22middle%22 dominant-baseline=%22central%22%3EPP%3C/text%3E%3C/svg%3E';
              }}
              loading="eager"
            />
