      ...
      <aside className={cn(
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-slate-800 bg-slate-900">
          <div className="flex items-center space-x-3 flex-1">
            {/* PartPulse Logo Icon - Simplified SVG (Icon Only) */}
            <svg
              width="32"
              height="32"
              viewBox="0 0 100 100"
            ...
            >
              <circle cx="30" cy="35" r="22" fill="#1e3a5f" />
              <circle cx="30" cy="35" r="18" fill="#154577" />
              <circle cx="30" cy="35" r="12" fill="#1e3a5f" />
              <circle cx="30" cy="35" r="6" fill="#2d3748" />
              <circle cx="70" cy="65" r="22" fill="#f36b32" opacity="0.9" />
              <circle cx="70" cy="65" r="18" fill="#e85a1f" />
              <circle cx="70" cy="65" r="12" fill="#f36b32" />
              <circle cx="70" cy="65" r="6" fill="#d94a10" />
              <path d="M 42 45 L 58 55" stroke="#b75d3e" strokeWidth="3" opacity="0.7" />
              <circle cx="50" cy="50" r="8" fill="none" stroke="#f36b32" strokeWidth="1.5" opacity="0.6" />
              <circle cx="50" cy="50" r="12" fill="none" stroke="#f36b32" strokeWidth="1" opacity="0.3" />
            </svg>
